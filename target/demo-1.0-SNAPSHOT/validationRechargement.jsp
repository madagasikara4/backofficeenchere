					...
					<div class="product">
						<div class="desc">
							...
							<form method="post" action="validationRecharge">
								<input type="hidden" name="id" value="<%=recharge[i].getIdrechargement()%>">
								<input type="hidden" name="numcompte" value="<%=recharge[i].getNumerocompte()%>">
								<input type="hidden" name="recharge" value="<%=recharge[i].getRecharge()%>">
