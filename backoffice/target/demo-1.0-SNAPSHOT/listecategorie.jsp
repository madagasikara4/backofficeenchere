                ...
                <div class="col-md-4 col-sm-4 text-center">
                    <div class="feature-center animate-box" data-animate-effect="fadeIn">
                        ...
                        <form action="CategorieUpdate" method="get">
                            <input type="hidden" name="idc" value="<%= categories[i].getIdcategorie()%>">
                            <input type="hidden" name="nom" value="<%= categories[i].getNomCategorie()%>">
                            <p><input type="submit" class="btn btn-primary btn-outline" value="Modifier"></p>
                        </form>
                        <p><a href="ProduitDureeList?c=<%= categories[i].getIdcategorie() %>" class="btn btn-primary btn-outline">Modifier Duree Produit</a></p>
                    </div>
                </div>
                <% }%>
            </div>
